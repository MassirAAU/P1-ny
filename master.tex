...
\input{sections/report/problemformulering.tex}
\input{sections/report/analysedel/analyseresult.tex}
\input{sections/report/losningforslag/losningforslag.tex}
\input{sections/report/perpektivering.tex}
\input{sections/report/diskussion.tex}
\printbibliography[heading=bibintoc]
\label{bib:mybiblio}
\appendix
\input{sections/report/appAname.tex}
\end{document}
